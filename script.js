...
const courses = [
  {
    ...
    price: 120,
    nowGolfPrice: 98,
    url: 'https://nowgolf.com/deals/hudson-links',
  ...
  },
  {
    ...
    price: 52,
    nowGolfPrice: 45,
    url: 'https://nowgolf.com/deals/brookside-muni',
  ...
  },
  {
    ...
    price: 215,
    nowGolfPrice: 189,
    url: 'https://nowgolf.com/deals/golden-gate-cliffs',
  ...
  },
  {
    ...
    price: 105,
    nowGolfPrice: 92,
    url: 'https://nowgolf.com/deals/mission-bay-links',
  ...
  },
  {
    ...
    price: 160,
    nowGolfPrice: 142,
    url: 'https://nowgolf.com/deals/lake-shore-club',
  ...
  },
  {
    ...
    price: 58,
    nowGolfPrice: 49,
    url: 'https://nowgolf.com/deals/prairie-dunes-muni',
  ...
  },
  {
    ...
    price: 185,
    nowGolfPrice: 165,
    url: 'https://nowgolf.com/deals/barton-hills-reserve',
  ...
  },
  {
    ...
    price: 48,
    nowGolfPrice: 39,
    url: 'https://nowgolf.com/deals/zilker-park-muni',
  ...
  },
  {
    ...
    price: 132,
    nowGolfPrice: 118,
    url: 'https://nowgolf.com/deals/everglades-pines',
  ...
  },
  {
    ...
    price: 69,
    nowGolfPrice: 59,
    url: 'https://nowgolf.com/deals/biscayne-breeze',
  ...
  },
  {
    ...
    price: 115,
    nowGolfPrice: 102,
    url: 'https://nowgolf.com/deals/northstar-trails',
  ...
  },
  {
    ...
    price: 140,
    nowGolfPrice: 126,
    url: 'https://nowgolf.com/deals/trinity-flats',
  ...
  },
  {
    ...
    price: 130,
    nowGolfPrice: 118,
    url: 'https://nowgolf.com/deals/caledonian-heath',
  ...
  },
  {
    ...
    price: 72,
    nowGolfPrice: 64,
    url: 'https://nowgolf.com/deals/firthside-links',
  ...
  },
  {
    ...
    price: 210,
    nowGolfPrice: 189,
    url: 'https://nowgolf.com/deals/royal-thames-downs',
  ...
  },
  {
    ...
    price: 76,
    nowGolfPrice: 67,
    url: 'https://nowgolf.com/deals/greenwich-park-golf',
...
function renderCards(courses, date, city, radius) {
  ...
  const cardsHtml = courses.map((course) => `
    <article class="card">
      ...
      <div class="row">
        <div>
          <div class="price">${course.nowGolfPrice ? `$${course.nowGolfPrice}` : 'NowGolf rate'}</div>
          <div class="subtext">Best NowGolf price for ${dateText}</div>
        </div>
        <a class="primary-link" href="${course.url}" target="_blank" rel="noreferrer">Book on NowGolf →</a>
      </div>
